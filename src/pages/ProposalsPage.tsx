...
export function NewProposalPage() {
  ...
  return (
    <div className="page page-narrow">
      ...
      <div className="card">
        <h2>Citations {needsCitation && <span className="muted">(at least one required)</span>} <Help text="Additions and edits must cite at least one source (DOI or PuRe handle). Search the journal's citation pool first; add a new one only if it is missing." /></h2>
